...
//QUESTION 12 
		...
		WebElement lnkSignIn = driver.findElement(By.xpath("//div[@class='accountInner']"));
		...
		actions.moveToElement(lnkRegister).perform();
		lnkRegister.click();
		Thread.sleep(3000);
		WebElement frameElement = driver.findElement(By.xpath("//iframe[@id='loginIframe']"));
