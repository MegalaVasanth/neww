...
//		 WebElement txthdfcUserID =driver.findElement(By.xpath("fldLoginUserId"));
//		 Thread.sleep(4000);
...
// QUESTION 8 
		...
		//WebElement txtUserName = driver.findElement(By.xpath("//input[@aria-label='Phone number, username, or email']"));
		Thread.sleep(3000);
